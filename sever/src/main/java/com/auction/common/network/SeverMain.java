...
public class SeverMain {
    ...
    // [THÊM] Port server lắng nghe - client sẽ kết nối tới localhost:5000
    private static final int PORT = 5000;

    // [THÊM] Thread pool: tối đa 10 client cùng lúc, queue unlimited client chờ
    ...
    public static void main(String[] args) {
        try {
            ...
            // [THÊM] Infinite loop: lắng nghe incoming connections
            ...
            while (true) {
                ...
                // [THÊM] Gửi Socket vào thread pool
            ...
            // [THÊM] Cleanup khi server shutdown
